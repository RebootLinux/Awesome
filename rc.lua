...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Comment by ryan
    -- Change the 'i' in awful.layout.layouts[2] to change the default layout across worskspaces
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "c", function () awful.spawn(clion) end,
              {description = "open a IDE", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "v", function () awful.spawn(code) end,
              {description = "open a IDE", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "d", function () awful.spawn(spacefm) end,
...
-- Enable sloppy focus, so that focus follows mouse.+R
...
--Autostart
awful.spawn.with_shell("feh --bg-scale /home/ryan/Pictures/space.jpg")
